...
public class QuickDemo : MonoBehaviour
{
    ...
    public void onLogin()
    {
        UnifySDK.UnifySDKManager.Instance.IUnifySDK_Account.Login(false);
    }
    ...
    public void onPay()
    {
        PurchaseOrderInfoData orderInfoData = new PurchaseOrderInfoData();
        orderInfoData.goodsID = "1";
        orderInfoData.goodsName = "勾玉";
        orderInfoData.goodsDesc = "10个勾玉";
        orderInfoData.quantifier = "个";
        orderInfoData.extrasParams = "extparma";
        orderInfoData.count = 10;
        orderInfoData.amount = 1;
        orderInfoData.price = 0.1f;
        orderInfoData.callbackUrl = "";
        orderInfoData.cpOrderID = "cporderidzzw";


        UnifySDKManager.Instance.IUnifySDK_Purchase.Purchase(orderInfoData);
        //QuickSDK.getInstance ().pay (orderInfoData, gameRoleInfo);
    }
    ...
    public void onCreatRole()
    {
        ...
        PurchaseRoleInfoData gameRoleInfoData = new PurchaseRoleInfoData();

        gameRoleInfoData.gameRoleBalance = "0";
        gameRoleInfoData.gameRoleID = "000001";
        gameRoleInfoData.gameRoleLevel = "1";
        gameRoleInfoData.gameRoleName = "钱多多";
        gameRoleInfoData.partyName = "同济会";
        gameRoleInfoData.serverID = "1";
        gameRoleInfoData.serverName = "火星服务器";
        gameRoleInfoData.vipLevel = "1";
        gameRoleInfoData.roleCreateTime = "roleCreateTime"; //UC与1881渠道必传，值为10位数时间戳

        gameRoleInfoData.gameRoleGender = "男"; //360渠道参数
        gameRoleInfoData.gameRolePower = "38"; //360渠道参数，设置角色战力，必须为整型字符串
        gameRoleInfoData.partyId = "1100"; //360渠道参数，设置帮派id，必须为整型字符串

        gameRoleInfoData.professionId = "11"; //360渠道参数，设置角色职业id，必须为整型字符串
        gameRoleInfoData.profession = "法师"; //360渠道参数，设置角色职业名称
        gameRoleInfoData.partyRoleId = "1"; //360渠道参数，设置角色在帮派中的id
        gameRoleInfoData.partyRoleName = "帮主"; //360渠道参数，设置角色在帮派中的名称
        gameRoleInfoData.friendlist = "无"; //360渠道参数，设置好友关系列表，格式请参考：http://open.quicksdk.net/help/detail/aid/190
        gameRoleInfoData.submitType = PurchaseRoleInfoData.SubmitType.CreateRole ;
        UnifySDKManager.Instance.IUnifySDK_Purchase.SubmitPurchaseRoleInfo(gameRoleInfoData);
    }
    ...
    public void onEnterGame()
    {
        ...
        gameRoleInfoData.gameRoleBalance = "0";
        gameRoleInfoData.gameRoleID = "11111";
        gameRoleInfoData.gameRoleLevel = "1";
        gameRoleInfoData.gameRoleName = "钱多多";
        gameRoleInfoData.partyName = "同济会";
        gameRoleInfoData.serverID = "1";
        ...
        gameRoleInfoData.partyRoleName = "帮主"; //360渠道参数，设置角色在帮派中的名称
        gameRoleInfoData.friendlist = "无"; //360渠道参数，设置好友关系列表，格式请参考：http://open.quicksdk.net/help/detail/aid/190
        gameRoleInfoData.submitType = PurchaseRoleInfoData.SubmitType.StartGame;

        UnifySDKManager.Instance.IUnifySDK_Purchase.SubmitPurchaseRoleInfo(gameRoleInfoData); //开始游戏
    ...
    public void onUpdateRoleInfo()
    {
        ...
        gameRoleInfoData.partyRoleName = "帮主"; //360渠道参数，设置角色在帮派中的名称
        gameRoleInfoData.friendlist = "无"; //360渠道参数，设置好友关系列表，格式请参考：http://open.quicksdk.net/help/detail/aid/190
        gameRoleInfoData.submitType = PurchaseRoleInfoData.SubmitType.UpdateRole;
    ...
    public void ongetDeviceId()
    {
        ...
        {
            showLog("deviceId", data.UDID);
            showLog("OAID", data.OAID);
        });
    }
    ...
    {
        UnifySDKManager.Instance.IUnifySDK.OnInitSuccess.ClearEventHandler();
        UnifySDKManager.Instance.IUnifySDK.OnInitSuccess.Handler += (objs, eventArgs) =>
        {
    ...
    {
        UnifySDKManager.Instance.IUnifySDK.OnInitFailed.ClearEventHandler();
        UnifySDKManager.Instance.IUnifySDK.OnInitFailed.Handler += (_data, eventArgs) =>
        {
