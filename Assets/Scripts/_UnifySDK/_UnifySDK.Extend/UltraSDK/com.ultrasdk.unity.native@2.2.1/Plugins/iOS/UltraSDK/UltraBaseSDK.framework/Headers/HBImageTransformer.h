 ...
 */
FOUNDATION_EXPORT NSString * _Nullable UltraTransformedKeyForKey(NSString * _Nullable key, NSString * _Nonnull transformerKey);
...
/**
 ...
 @note If you have both transformer and thumbnail applied for image, call `SDThumbnailedKeyForKey` firstly and then with `UltraTransformedKeyForKey`.`
 */
...
/**
 ...
 You can provide transformer to cache and manager (Through the `transformer` property or context option `UltraWebImageContextImageTransformer`).
 
 @note The transform process is called from a global queue in order to not to block the main queue.
 */
@protocol HBImageTransformer <NSObject>
 ...
 */
@interface HBImagePipelineTransformer : NSObject <HBImageTransformer>

/**
 All transformers in pipeline
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<id<HBImageTransformer>> *transformers;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithTransformers:(nonnull NSArray<id<HBImageTransformer>> *)transformers;

@end

// There are some built-in transformers based on the `UIImage+HBTransformer` category to provide the common image geometry, image blending and image effect process. Those transform are useful for static image only but you can create your own to support animated image as well.
 ...
 */
@interface HBImageRoundCornerTransformer: NSObject <HBImageTransformer>
 ...
 */
@interface HBImageResizingTransformer : NSObject <HBImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) HBImageScaleMode scaleMode;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithSize:(CGSize)size scaleMode:(HBImageScaleMode)scaleMode;
 ...
 */
@interface HBImageCroppingTransformer : NSObject <HBImageTransformer>
 ...
 */
@interface HBImageFlippingTransformer : NSObject <HBImageTransformer>
 ...
 */
@interface HBImageRotationTransformer : NSObject <HBImageTransformer>
 ...
 */
@interface HBImageTintTransformer : NSObject <HBImageTransformer>
 ...
 */
@interface HBImageBlurTransformer : NSObject <HBImageTransformer>
 ...
 */
@interface HBImageFilterTransformer: NSObject <HBImageTransformer>
