...
typedef NSString * HBImageCoderOption NS_STRING_ENUM;
typedef NSDictionary<HBImageCoderOption, id> HBImageCoderOptions;
typedef NSMutableDictionary<HBImageCoderOption, id> HBImageCoderMutableOptions;
...
/**
 ...
 @note works for `HBImageCoder`.
 */
FOUNDATION_EXPORT HBImageCoderOption _Nonnull const HBImageCoderDecodeFirstFrameOnly;
...
/**
 ...
 @note works for `HBImageCoder`, `UltraProgressiveImageCoder`, `HBAnimatedImageCoder`.
 */
FOUNDATION_EXPORT HBImageCoderOption _Nonnull const HBImageCoderDecodeScaleFactor;
...
/**
 ...
 @note works for `HBImageCoder`, `UltraProgressiveImageCoder`, `HBAnimatedImageCoder`.
 */
FOUNDATION_EXPORT HBImageCoderOption _Nonnull const HBImageCoderDecodePreserveAspectRatio;
...
/**
 ...
 @note works for `HBImageCoder`, `UltraProgressiveImageCoder`, `HBAnimatedImageCoder`.
 */
FOUNDATION_EXPORT HBImageCoderOption _Nonnull const HBImageCoderDecodeThumbnailPixelSize;
...
/**
 ...
 @note works for `HBImageCoder`.
 */
FOUNDATION_EXPORT HBImageCoderOption _Nonnull const HBImageCoderEncodeFirstFrameOnly;
/**
 ...
 @note works for `HBImageCoder`
 */
FOUNDATION_EXPORT HBImageCoderOption _Nonnull const HBImageCoderEncodeCompressionQuality;
...
/**
 ...
 @note works for `HBImageCoder`
 */
FOUNDATION_EXPORT HBImageCoderOption _Nonnull const HBImageCoderEncodeBackgroundColor;
...
/**
 ...
 @note works for `HBImageCoder`
 */
FOUNDATION_EXPORT HBImageCoderOption _Nonnull const HBImageCoderEncodeMaxFileSize;
...
/**
 ...
 @note works for `HBImageCoder`
 */
FOUNDATION_EXPORT HBImageCoderOption _Nonnull const HBImageCoderEncodeEmbedThumbnail;

/**
 A UltraWebImageContext object which hold the original context options from top-level API. (UltraWebImageContext)
 ...
 See `UltraWebImageContext` for more detailed information.
 */
FOUNDATION_EXPORT HBImageCoderOption _Nonnull const HBImageCoderWebImageContext API_DEPRECATED("The coder component will be seperated from Core subspec in the future. Update your code to not rely on this context option.", macos(10.10, API_TO_BE_DEPRECATED), ios(8.0, API_TO_BE_DEPRECATED), tvos(9.0, API_TO_BE_DEPRECATED), watchos(2.0, API_TO_BE_DEPRECATED));;
 ...
 */
@protocol HBImageCoder <NSObject>
...
/**
 ...
 @note This protocol may supports decode animated image frames. You can use `+[HBImageCoderHelper animatedImageWithFrames:]` to produce an animated image with frames.

 @param data The image data to be decoded
 @param options A dictionary containing any decoding options. Pass @{HBImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for image. Pass @{HBImageCoderDecodeFirstFrameOnly: @(YES)} to decode the first frame only.
 @return The decoded image from data
 */
- (nullable UIImage *)decodedImageWithData:(nullable NSData *)data
                                   options:(nullable HBImageCoderOptions *)options;

#pragma mark - Encoding

/**
 Returns YES if this coder can encode some image. Otherwise, it should be passed to another coder.
 For custom coder which introduce new image format, you'd better define a new `HBImageFormat` using like this. If you're creating public coder plugin for new image format, also update `https://github.com/rs/UltraWebImage/wiki/Coder-Plugin-List` to avoid same value been defined twice.
 * @code
 static const HBImageFormat HBImageFormatHEIF = 10;
 * @endcode
 
 @param format The image format
 @return YES if this coder can encode the image, NO otherwise
 */
- (BOOL)canEncodeToFormat:(HBImageFormat)format NS_SWIFT_NAME(canEncode(to:));

/**
 Encode the image to image data.
 @note This protocol may supports encode animated image frames. You can use `+[HBImageCoderHelper framesFromAnimatedImage:]` to assemble an animated image with frames.

 @param image The image to be encoded
 @param format The image format to encode, you should note `HBImageFormatUndefined` format is also  possible
 @param options A dictionary containing any encoding options. Pass @{HBImageCoderEncodeCompressionQuality: @(1)} to specify compression quality.
 @return The encoded image data
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image
                                   format:(HBImageFormat)format
                                  options:(nullable HBImageCoderOptions *)options;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol UltraProgressiveImageCoder <HBImageCoder>
...
/**
 ...
 @param options A dictionary containing any progressive decoding options (instance-level). Pass @{HBImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for progressive animated image (each frames should use the same scale).
 @return A new instance to do incremental decoding for the specify image format
 */
- (nonnull instancetype)initIncrementalWithOptions:(nullable HBImageCoderOptions *)options;
...
/**
 ...
 @note Due to the performance issue for progressive decoding and the integration for image view. This method may only return the first frame image even if the image data is animated image. If you want progressive animated image decoding, conform to `HBAnimatedImageCoder` protocol as well and use `animatedImageFrameAtIndex:` instead.

 @param options A dictionary containing any progressive decoding options. Pass @{HBImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for progressive image
 @return The decoded image from current data
 */
- (nullable UIImage *)incrementalDecodedImageWithOptions:(nullable HBImageCoderOptions *)options;

@end

#pragma mark - Animated Image Provider
/**
 This is the animated image protocol to provide the basic function for animated image rendering. It's adopted by `HBAnimatedImage` and `HBAnimatedImageCoder`
 */
@protocol HBAnimatedImageProvider <NSObject>
...
/**
 This is the animated image coder protocol for custom animated image class like  `HBAnimatedImage`. Through it inherit from `HBImageCoder`. We currentlly only use the method `canDecodeFromData:` to detect the proper coder for specify animated image format.
 */
@protocol HBAnimatedImageCoder <HBImageCoder, HBAnimatedImageProvider>
...
/**
 ...
 After the instance created, we may call methods in `HBAnimatedImageProvider` to produce animated image frame.

 @param data The animated image data to be decode
 @param options A dictionary containing any animated decoding options (instance-level). Pass @{HBImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for animated image (each frames should use the same scale).
 @return A new instance to do animated decoding for specify image data
 */
- (nullable instancetype)initWithAnimatedImageData:(nullable NSData *)data options:(nullable HBImageCoderOptions *)options;
