...
/**
 ...
 Coders
 ------
 A coder must conform to the `HBImageCoder` protocol or even to `UltraProgressiveImageCoder` if it supports progressive decoding
 ...
 */
@interface HBImageCodersManager : NSObject <HBImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) HBImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<HBImageCoder>> *coders;
...
/**
 ...
 @param coder coder
 */
- (void)addCoder:(nonnull id<HBImageCoder>)coder;
...
/**
 ...
 @param coder coder
 */
- (void)removeCoder:(nonnull id<HBImageCoder>)coder;
