...
@class HBImageCacheConfig;
/**
 A protocol to allow custom memory cache used in HBImageCache.
 */
@protocol HBMemoryCache <NSObject>
 ...
 */
- (nonnull instancetype)initWithConfig:(nonnull HBImageCacheConfig *)config;
 ...
 */
@interface HBMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <HBMemoryCache>

@property (nonatomic, strong, nonnull, readonly) HBImageCacheConfig *config;
