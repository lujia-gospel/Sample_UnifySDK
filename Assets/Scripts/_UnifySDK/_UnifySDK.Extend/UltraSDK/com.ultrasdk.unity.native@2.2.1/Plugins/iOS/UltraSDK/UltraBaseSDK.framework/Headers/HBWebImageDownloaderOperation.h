...
/**
 ...
 For the description about these methods, see `HBWebImageDownloaderOperation`
 ...
 */
@protocol HBWebImageDownloaderOperation <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
@required
...
- (nullable id)addHandlersForProgress:(nullable HBWebImageDownloaderProgressBlock)progressBlock
...
/**
 The download operation class for HBWebImageDownloader.
 */
@interface HBWebImageDownloaderOperation : NSOperation <HBWebImageDownloaderOperation>
 ...
 */
@property (assign, nonatomic, readonly) HBWebImageDownloaderOptions options;

/**
 * The context for the receiver.
 */
@property (copy, nonatomic, readonly, nullable) UltraWebImageContext *context;

/**
 *  Initializes a `HBWebImageDownloaderOperation` object
 *
 *  @see HBWebImageDownloaderOperation
 *
...
- (nonnull instancetype)initWithRequest:(nullable NSURLRequest *)request
                              inSession:(nullable NSURLSession *)session
                                options:(HBWebImageDownloaderOptions)options
                                context:(nullable UltraWebImageContext *)context NS_DESIGNATED_INITIALIZER;
