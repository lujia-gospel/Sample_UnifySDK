...
extern NSString *const kHBKeychainErrorDomain;

/** Account name. */
extern NSString *const kHBKeychainAccountKey;
 ...
 */
extern NSString *const kHBKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kHBKeychainClassKey;

/** Item description. */
extern NSString *const kHBKeychainDescriptionKey;

/** Item label. */
extern NSString *const kHBKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kHBKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kHBKeychainWhereKey;
