 ...
 */
@interface HBImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<HBImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<HBImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage NS_SWIFT_NAME(frames(from:));
