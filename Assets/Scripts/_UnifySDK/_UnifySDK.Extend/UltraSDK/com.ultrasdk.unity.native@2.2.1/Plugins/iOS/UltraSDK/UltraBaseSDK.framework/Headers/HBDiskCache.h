...
/**
 A protocol to allow custom disk cache used in HBImageCache.
 */
@protocol HBDiskCache <NSObject>
 ...
 */
- (nullable instancetype)initWithCachePath:(nonnull NSString *)cachePath config:(nonnull HBImageCacheConfig *)config;
 ...
 */
@interface HBDiskCache : NSObject <HBDiskCache>
/**
 Cache Config object - storing all kind of settings.
 */
@property (nonatomic, strong, readonly, nonnull) HBImageCacheConfig *config;
