 ...
 */
- (nullable id<HBWebImageOperation>)hb_imageLoadOperationForKey:(nullable NSString *)key;
 ...
 */
- (void)hb_setImageLoadOperation:(nullable id<HBWebImageOperation>)operation forKey:(nullable NSString *)key;
 ...
 *  @param key key for identifying the operations
 */
- (void)hb_cancelImageLoadOperationWithKey:(nullable NSString *)key;
 ...
 *  @param key key for identifying the operations
 */
- (void)hb_removeImageLoadOperationWithKey:(nullable NSString *)key;
