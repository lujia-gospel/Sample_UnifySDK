 ...
 */
@property (nonatomic, assign) BOOL hb_isDecoded;
 ...
 */
+ (nullable UIImage *)hb_decodedImageWithImage:(nullable UIImage *)image;
 ...
 */
+ (nullable UIImage *)hb_decodedAndScaledDownImageWithImage:(nullable UIImage *)image;
...
/**
 ...
 @return The decoded and scaled down image
 */
+ (nullable UIImage *)hb_decodedAndScaledDownImageWithImage:(nullable UIImage *)image limitBytes:(NSUInteger)bytes;
