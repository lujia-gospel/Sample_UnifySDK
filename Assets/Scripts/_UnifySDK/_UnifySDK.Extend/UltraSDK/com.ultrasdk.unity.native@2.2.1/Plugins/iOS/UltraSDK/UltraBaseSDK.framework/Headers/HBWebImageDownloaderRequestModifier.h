...
typedef NSURLRequest * _Nullable (^HBWebImageDownloaderRequestModifierBlock)(NSURLRequest * _Nonnull request);
 ...
 */
@protocol HBWebImageDownloaderRequestModifier <NSObject>
 ...
 */
@interface HBWebImageDownloaderRequestModifier : NSObject <HBWebImageDownloaderRequestModifier>

/// Create the request modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull HBWebImageDownloaderRequestModifierBlock)block;

/// Create the request modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)requestModifierWithBlock:(nonnull HBWebImageDownloaderRequestModifierBlock)block;
...
*/
@interface HBWebImageDownloaderRequestModifier (Conveniences)
