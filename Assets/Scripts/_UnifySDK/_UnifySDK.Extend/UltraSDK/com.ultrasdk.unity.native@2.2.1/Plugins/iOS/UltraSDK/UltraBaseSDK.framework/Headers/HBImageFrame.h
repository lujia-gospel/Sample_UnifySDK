...
/**
 This class is used for creating animated images via `animatedImageWithFrames` in `HBImageCoderHelper`.
 @note If you need to specify animated images loop count, use `hb_imageLoopCount` property in `UIImage+HBMetadata.h`.
 */
@interface HBImageFrame : NSObject
