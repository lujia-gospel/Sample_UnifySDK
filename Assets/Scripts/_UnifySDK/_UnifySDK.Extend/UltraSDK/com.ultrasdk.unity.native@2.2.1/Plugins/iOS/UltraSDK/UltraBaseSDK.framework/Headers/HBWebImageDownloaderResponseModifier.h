...
typedef NSURLResponse * _Nullable (^HBWebImageDownloaderResponseModifierBlock)(NSURLResponse * _Nonnull response);
 ...
 */
@protocol HBWebImageDownloaderResponseModifier <NSObject>
...
/// @note If nil is returned, the image download will marked as cancelled with error `HBWebImageErrorInvalidDownloadResponse`
 ...
 */
@interface HBWebImageDownloaderResponseModifier : NSObject <HBWebImageDownloaderResponseModifier>

/// Create the response modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull HBWebImageDownloaderResponseModifierBlock)block;

/// Create the response modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)responseModifierWithBlock:(nonnull HBWebImageDownloaderResponseModifierBlock)block;
...
*/
@interface HBWebImageDownloaderResponseModifier (Conveniences)
