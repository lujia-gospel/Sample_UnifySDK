 ...
 */
@interface HBImageIOAnimatedCoder : NSObject <UltraProgressiveImageCoder, HBAnimatedImageCoder>

#pragma mark - Subclass Override
/**
 The supported animated image format. Such as `HBImageFormatGIF`.
 @note Subclass override.
 */
@property (class, readonly) HBImageFormat imageFormat;
/**
 The supported image format UTI Type. Such as `kUTTypeGIF`.
 This can be used for cases when we can not detect `HBImageFormat. Such as progressive decoding's hint format `kCGImageSourceTypeIdentifierHint`.
 @note Subclass override.
 */
