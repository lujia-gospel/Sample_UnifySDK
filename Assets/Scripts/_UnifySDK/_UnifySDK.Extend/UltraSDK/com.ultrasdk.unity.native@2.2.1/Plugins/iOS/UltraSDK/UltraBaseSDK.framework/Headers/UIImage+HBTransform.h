...
typedef NS_ENUM(NSUInteger, HBImageScaleMode) {
    HBImageScaleModeFill = 0,
    HBImageScaleModeAspectFit = 1,
    HBImageScaleModeAspectFill = 2
};

#if HB_UIKIT || HB_WATCH
 ...
 */
- (nullable UIImage *)hb_resizedImageWithSize:(CGSize)size scaleMode:(HBImageScaleMode)scaleMode;
 ...
 */
- (nullable UIImage *)hb_croppedImageWithRect:(CGRect)rect;
 ...
 */
- (nullable UIImage *)hb_roundedCornerImageWithRadius:(CGFloat)cornerRadius
 ...
 */
- (nullable UIImage *)hb_rotatedImageWithAngle:(CGFloat)angle fitSize:(BOOL)fitSize;
 ...
 */
- (nullable UIImage *)hb_flippedImageWithHorizontal:(BOOL)horizontal vertical:(BOOL)vertical;
 ...
 */
- (nullable UIImage *)hb_tintedImageWithColor:(nonnull UIColor *)tintColor;
 ...
 */
- (nullable UIColor *)hb_colorAtPoint:(CGPoint)point;
...
/**
 ...
 @note The rect's width/height should not be smaller than or equal to 0. The minX/minY should not be smaller than 0. The maxX/maxY should not be greater than width/height. Attention this limit is different from `hb_colorAtPoint:` (point: (0, 0) like rect: (0, 0, 1, 1))
 @note The overhead of object creation means this method is best suited for infrequent color sampling. For heavy image processing, grab the raw bitmap data and process yourself.

 @param rect The rectangle of pixels
 @return The color array for specify pixels, or nil if any error occur
 */
- (nullable NSArray<UIColor *> *)hb_colorsWithRect:(CGRect)rect;
 ...
 */
- (nullable UIImage *)hb_blurredImageWithRadius:(CGFloat)blurRadius;
...
/**
 ...
 enough memory).
 */
- (nullable UIImage *)hb_filteredImageWithFilter:(nonnull CIFilter *)filter;
#endif
