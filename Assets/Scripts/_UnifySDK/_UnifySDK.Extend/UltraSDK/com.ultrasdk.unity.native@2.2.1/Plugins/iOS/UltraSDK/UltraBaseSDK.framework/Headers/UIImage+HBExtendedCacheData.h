...
/**
 ...
 @note The disk cache preserve both of the data and extended data with the same cache key. For manual query, use the `HBDiskCache` protocol method `extendedDataForKey:` instead.
 ...
 */
@property (nonatomic, strong, nullable) id<NSObject, NSCoding> hb_extendedObject;
