 ...
 */
+ (nullable UIImage *)hb_imageWithData:(nullable NSData *)data;
...
/**
 ...
 @return The created image
 */
+ (nullable UIImage *)hb_imageWithData:(nullable NSData *)data scale:(CGFloat)scale;
...
/**
 ...
 @return The created image
 */
+ (nullable UIImage *)hb_imageWithData:(nullable NSData *)data scale:(CGFloat)scale firstFrameOnly:(BOOL)firstFrameOnly;

#pragma mark - Encode
/**
 Encode the current image to the data, the image format is unspecified

 @note If the receiver is `HBAnimatedImage`, this will return the animated image data if available. No more extra encoding process.
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)hb_imageData;
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)hb_imageDataAsFormat:(HBImageFormat)imageFormat NS_SWIFT_NAME(hb_imageData(as:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)hb_imageDataAsFormat:(HBImageFormat)imageFormat compressionQuality:(double)compressionQuality NS_SWIFT_NAME(hb_imageData(as:compressionQuality:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)hb_imageDataAsFormat:(HBImageFormat)imageFormat compressionQuality:(double)compressionQuality firstFrameOnly:(BOOL)firstFrameOnly NS_SWIFT_NAME(hb_imageData(as:compressionQuality:firstFrameOnly:));
