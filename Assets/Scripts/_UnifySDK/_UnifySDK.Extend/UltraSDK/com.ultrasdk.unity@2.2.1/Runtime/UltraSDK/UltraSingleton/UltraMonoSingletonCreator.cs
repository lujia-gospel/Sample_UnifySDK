...
{
    internal class UltraMonoSingletonCreator
    {
        public static bool IsUnitTestMode { get; set; }

        public static T CreateMonoSingleton<T>() where T : MonoBehaviour, UltraISingleton
        {
            T instance = null;
            ...
            if (instance != null)
            {
                // Debug.Log($"MonoSingleton Lifecycle {instance.GetType().Name} : OnSingletonInit");
            ...
            {
                var defineAttri = atribute as UltraHMonoSingletonPath;
                if (defineAttri == null)
                {
                    continue;
                }
        ...
        private static T CreateComponentOnGameObject<T>(string path, bool dontDestroy) where T : MonoBehaviour
        {
            ...
            if (obj == null)
            {
                obj = new GameObject("HSingleton of " + typeof(T).Name);
