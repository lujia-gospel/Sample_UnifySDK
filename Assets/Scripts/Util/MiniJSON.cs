...
public static class MiniJSON
{
    ...
    {
        // Fields
        [CompilerGenerated] private static Dictionary<string, int> f__switch;
                ...
                if (this.json.Peek() != -1)
                {
                    ...
                    if (nextWord != null)
                    {
                        ...
                        if (f__switch == null)
                        {
                            ...
                            f__switch = dictionary;
                        }

                        if (f__switch.TryGetValue(nextWord, out num))
                        {
                            switch (num)
                            {
                                case 0:
    ...
    private sealed class Serializer
    {
        ...
        private void SerializeOther(object value)
        {
            ...
            else if (value is Vector2)
            {
                ...
                this.builder.Append("\"(" + vector.x.ToString("R", CultureInfo.InvariantCulture) + "," +
                                    vector.y.ToString("R", CultureInfo.InvariantCulture) + ")\"");
            }
            else if (value is Vector3)
            {
                Vector3 vector2 = (Vector3) value;
                this.builder.Append("\"(" + vector2.x.ToString("R", CultureInfo.InvariantCulture) + "," +
            ...
            else if (value is Vector4)
            {
                ...
                this.builder.Append("\"(" + vector3.x.ToString("R", CultureInfo.InvariantCulture) + "," +
            ...
            else if (value is Quaternion)
            {
                ...
                this.builder.Append("\"(" + quaternion.x.ToString("R", CultureInfo.InvariantCulture) + "," +
